...
<script>
	...
	function showModProduct( id )
	{
		...
		if( id )
		{
			$.ajax({
				type: "POST",
				url: "process/process-crud-product.php?tampil",
				dataType: 'json',
				data: {id:id},
	...
	function submitAddProduct()
	{
		...
		$.ajax({
			type:"POST",
			url:"process/process-crud-product.php?save",
			data:formData,
			success:function(data){
				//waitingDialog.hide();			
				dTable.ajax.reload(); 
	...
	function submiteditProduct()
	{
		...
		$.ajax({
			type:"POST",
			url:"process/process-crud-product.php?update",
			data:formData,
			success:function(data){
				//waitingDialog.hide();			
				dTable.ajax.reload(); 
	...
	function submitdelProduct()
	{
		...
		$.ajax({
			type:"POST",
			url:"process/process-crud-product.php?delete",
			data:formData,
			success:function(data){
				//waitingDialog.hide();			
				dTable.ajax.reload(); 
